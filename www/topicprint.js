      ...
      d3.json(host + "/topics.json", function (error_top, topics) {
        ...
        doc.selectAll("rect")
          ...
          .attr("title", function (d) {
            return d3.keys(topics[d.name]['words']).sort(function (a, b) {
...
$.get('description.md')
  ...
  .fail(function () {
    $.get('../description.md')
      ...
      .fail(
        function (data) {
          $('#aboutText').html('To add a description of this corpus, create a Markdown file and edit the main:corpus_desc option in config.ini.');
        })
  });
